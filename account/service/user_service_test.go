...
import (
	...
	"github.com/pienaahj/memrizr/account/model/fixture"
...
func TestGet(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		//  requests to FindByID method should return the mockUserResp as created above
	...
	t.Run("Error", func(t *testing.T) {
		...
		//  we don't need a real context carrying the user here just a non-nil one to test
		ctx := context.TODO()
		u, err := us.Get(ctx, uid)
